...
# The main test script for pySRUPLib's SRUP_Deregister_Request() class...


def test_deregister_request_type():
    x = pySRUPLib.SRUP_Deregister_Request()
    assert x.msg_type == pySRUPLib.__deregister_request_message_type()


def test_deregister_request_seqid():
...
def test_deregister_request_sender():
...
def test_deregister_request_token():
    x = pySRUPLib.SRUP_Deregister_Request()
...
def test_deregister_request_signing():
    blank = ""
...
def test_deregister_request_serializer():
    x = pySRUPLib.SRUP_Deregister_Request()
    x.token = "TOKEN12345"
    x.sequence_id = 0x1234567890ABCDEF
    x.sender_id = 0x5F5F5F5F5F5F5F5F
...
def test_deregister_request_deserializer():
    token = "TOKEN12345"
    ...
    assert i.msg_type == pySRUPLib.__deregister_request_message_type()
...
def test_deregister_request_deserializer():
    ...
    x = pySRUPLib.SRUP_Deregister_Request()
    y = pySRUPLib.SRUP_Deregister_Request()
