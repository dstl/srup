...
# The main test script for pySRUPLib's SRUP_Resign_Request() class...


def test_resign_request_type():
    x = pySRUPLib.SRUP_Resign_Request()
    assert x.msg_type == pySRUPLib.__resign_request_message_type()


def test_resign_request_seqid():
...
def test_resign_request_sender():
...
def test_resign_request_signing():
    blank = ""
...
def test_resign_request_serializer():
    x = pySRUPLib.SRUP_Resign_Request()
    x.token = "TOKEN12345"
    x.sequence_id = 0x1234567890ABCDEF
    x.sender_id = 0x5F5F5F5F5F5F5F5F
...
def test_resign_request_deserializer():
    token = "TOKEN12345"
    seq_id = 0x1234567890ABCDEF
    send_id = 0x5F5F5F5F5F5F5F5F

    x = pySRUPLib.SRUP_Resign_Request()
    y = pySRUPLib.SRUP_Resign_Request()
...
def test_resign_request_generic_deserializer():
    token = "TOKEN12345"
    seq_id = 0x1234567890ABCDEF
    send_id = 0x5F5F5F5F5F5F5F5F
    ...
    assert i.msg_type == pySRUPLib.__resign_request_message_type()
