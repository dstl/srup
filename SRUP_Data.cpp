...
const uint8_t SRUP_MSG_DATA::data_uint8()
{
    uint8_t d;
    std::memcpy(&d, m_data, 1);
    return d;
}

const int8_t SRUP_MSG_DATA::data_int8()
{
    int8_t d;
    std::memcpy(&d, m_data, 1);
    return d;
...
const uint16_t SRUP_MSG_DATA::data_uint16()
{
    uint16_t d;
    std::memcpy(&d, m_data, 2);
    return d;
}
const int16_t SRUP_MSG_DATA::data_int16()
{
    int16_t d;
    std::memcpy(&d, m_data, 2);
    return d;
...
const uint32_t SRUP_MSG_DATA::data_uint32()
{
    uint32_t d;
    std::memcpy(&d, m_data, 4);
    return d;
}
const int32_t SRUP_MSG_DATA::data_int32()
{
    int32_t d;
    std::memcpy(&d, m_data, 4);
    return d;
...
const uint64_t SRUP_MSG_DATA::data_uint64()
{
    uint64_t d;
    std::memcpy(&d, m_data, 8);
    return d;
}

const int64_t SRUP_MSG_DATA::data_int64()
{
    int64_t d;
    std::memcpy(&d, m_data, 8);
    return d;
...
const float SRUP_MSG_DATA::data_float()
{
    float d;
    std::memcpy(&d, m_data, 4);
    return d;
...
const double SRUP_MSG_DATA::data_double()
{
    double d;
    std::memcpy(&d, m_data, 8);
    return d;
